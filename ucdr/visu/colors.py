...
COL_DICT = {
  "red": [255, 89, 94],  # FF595E
  "yellow": [255, 202, 58],  # FFCA3A
  "green": [138, 201, 38],  # 8AC926
  "blue": [25, 130, 196],  # 1982C4
  "purple": [106, 76, 147],  # 6A4C93
}
...
RG_PASTEL = make_colormap([COL_MAP(0)[:3], COL_MAP(2)[:3]])
RG_PASTEL_r = make_colormap([COL_MAP(0)[:3], COL_MAP(2)[:3]])
